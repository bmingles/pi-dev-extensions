...
matters for this repo in particular — `pi -e extensions/host/devcontainer`
...
```bash
pi -e /path/to/pi-dev-extensions/extensions/host/devcontainer -e /path/to/pi-dev-extensions/extensions/host/caffeinate
```
...
```bash
PI_CAFFEINATE_ARGS="-d -i -m -s" pi -e /path/to/pi-dev-extensions/extensions/host/caffeinate
```
